...
class TriangleTest
{
    ...
    public void findIntersections() {
        ...
        if (result != null)// כנראה שלא תקני לברר איך לשנות צריך לשאול אם תקני
        {
            assertEquals(1, result.size(), "Wrong number of points");
            assertEquals(new Point(0.25d, 0.25d, 0.5d), result.get(0).cutTwoNumbers(), "Ray doesn't intersect the triangle");
        }
