...
public class PlaneTest {
    ...
    public void findIntersections() {
        ...
        assertEquals(new Point(0,1,0),result.get(0).cutTwoNumbers(),"Ray intersects the plane");
        ...
        assertEquals(result.size(),1,"Wrong number of points");
        assertEquals(new Point(n,n,n), result.get(0).cutTwoNumbers()," Ray starts before the plane. Ray is orthogonal to the plane");
